...
- [ ] A2. `AppScreen` scaffold — applies theme + `data-app`, header/status/body/footer
...
### Receivers
- [ ] nfm_audio · [ ] wfm_rx · [ ] am_rx · [ ] usb_rx+lsb_rx (one component) · [ ] cw_rx · [ ] rds_rx · [ ] adsb_rx · [ ] adsb_rx_ext
