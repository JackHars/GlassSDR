//! Pager Aggregator app. Parallel POCSAG + FLEX decode on the same channel, unified page stream.
...
impl App for PagerAggregatorApp {
    fn metadata() -> AppMetadata
    where
        Self: Sized,
    {
        AppMetadata {
            id: AppId::PagerAggregator,
            name: "Pager Aggregator".to_string(),
