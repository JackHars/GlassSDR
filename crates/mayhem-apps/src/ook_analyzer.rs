//! OOK Analyzer app. Captures OOK pulse trains and emits pulse events.
...
impl App for OokAnalyzerApp {
    fn metadata() -> AppMetadata
    where
        Self: Sized,
    {
        AppMetadata {
            id: AppId::OokAnalyzer,
            name: "OOK Analyzer".to_string(),
