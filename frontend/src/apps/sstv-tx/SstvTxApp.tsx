...
export function SstvTxApp() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <h2>SSTV Transmitter</h2>
      <p style={{ color: "#aaa", fontSize: 13 }}>Robot36 mode — 320×240 grayscale, FM sub-carrier</p>

      <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: 8, maxWidth: 500 }}>
        <label>Frequency (Hz)</label>
        <input type="number" value={frequency} onChange={(e) => setFrequency(e.target.value)} placeholder="e.g. 14230000" style={inputStyle} />
      ...
      <div style={{ marginTop: 12, padding: 8, background: "#1a1a2a", borderRadius: 4, border: "1px dashed #444" }}>
        <span style={{ color: "#888", fontSize: 12 }}>Image source: 320×240 test pattern (placeholder — image picker coming in v0.4)</span>
      </div>
