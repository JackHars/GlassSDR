  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <p style={{ color: "#aaa", fontSize: 13 }}>
        Passive BLE scanner — rotates advertising channels and reports all visible advertisers.
      </p>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
        ...
        <button onClick={handleStart} style={btnStyle("#2a6")}>Scan</button>
